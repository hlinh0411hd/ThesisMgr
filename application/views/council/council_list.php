...
<div class="center panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">Hội đồng khóa luận</h3>
        <div class="pull-right"><button  onclick="" type="button" class="btn btn-primary btn-xs">Xuất biên bản hội đồng</button></div>
    </div>
